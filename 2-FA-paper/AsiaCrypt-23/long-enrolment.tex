...
\begin{center}
    \    \begin{tcolorbox}[enhanced,width=4.75in, height=170mm, left=1mm,top=-.5mm,
...
%  \pcln \forEach i \in[1,d]: \< \< \\
 ...
 %
 \pcln \< \<\hspace{2.6mm} \text{Store \VM{\verifier} as \VS{\verifier}} \textcolor{blue}{\text{ and } w^{\sss M} \text{ as }   w^{\sss S}}\\
 %
