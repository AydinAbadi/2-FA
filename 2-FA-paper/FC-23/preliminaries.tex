...
\subsection{Pseudorandom Function}\label{subsec:PRF}
  \vspace{-1mm}
Informally, a pseudorandom function (\prf) is a deterministic function that takes as input a key and some argument. It outputs a value  indistinguishable from that of a truly random function with the same domain and range.   A $\prf$ is formally defined as follows \cite{KatzLindell2014}. \todo{Can we move to appendix}
  \vspace{-1mm}
