...
\begin{center}
     \begin{tcolorbox}[enhanced,width=4.75in, height=194mm, left=1mm,top=-3.4mm,
    drop fuzzy shadow southwest,
    colframe=black,colback=white]
%{\small{
 \centering
...
In Appendix \ref{sec::Straw-man-Solutions}, we present a couple of straw-man solutions (that one might be tempted to use to achieve the same goals that our protocol attains) and explain why they would not work. 
%
