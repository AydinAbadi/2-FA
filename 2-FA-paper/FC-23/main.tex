...
However, existing 2FA protocols leave the PIN vulnerable should the server, client, or hardware device be compromised.
...
Compared to previous work, our protocol reduces the cost of authentication devices by not requiring tamper-resistant hardware or that the authentication device be connected to the client, and through only using efficient symmetric cryptographic primitives.
